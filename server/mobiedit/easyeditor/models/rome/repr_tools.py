...
def get_reprs_at_idxs(
    ...
    # print(f"Debug - Module template: {module_template}")
    module_name = module_template.format(layer)
    # print(f"Debug - Full module name: {module_name}")
    
    # 打印模型的所有层
    # print("Debug - Available model layers:")
    ...
    for batch_contexts, batch_idxs in _batch(n=128):
        ...
        with torch.no_grad():
            try:
                ...
                print(f"Error accessing layer {module_name}")
