...
log_dir = './hparams_log'
n_range = range(2, 7)  # n=2,3,4,5,6
log_files = [f'test_llama3.2_zsreall_zoprefix-{n}_128.log' for n in n_range]
...
# 确保输出目录存在
os.makedirs(os.path.dirname('./llama3.2_zsreall_all.pdf'), exist_ok=True)
plt.savefig('./llama3.2_zsreall_all.pdf', bbox_inches='tight', dpi=300)
plt.show()